        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Tên loại đơn hàng">
                </div>
                <div class="form-group">
            ...
            <!-- /.box-body -->
                <div class="box-footer btn-group">
                    <a href="{{ route('admin.order-statuses.index') }}" class="btn btn-default">Quay lại danh sách</a>
