...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-body">
                <h2>Loại tình trạng đơn hàng</h2>
                <table class="table">
                    <thead>
                        <tr>
                            <td class="col-md-5">Tên loại</td>
                            <td class="col-md-5">Màu sắc</td>
                            ...
                            <td>
                                <form action="{{ route('admin.order-statuses.destroy', $status->id) }}" method="post" class="form-horizontal">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <button onclick="return confirm('Bạn chắc chắn thực hiện thành động này?')" type="submit" class="btn btn-danger btn-sm"><i class="fa fa-times"></i> Delete</button>
                                    </div>
                                </form>
                            </td>
                        </tr>
