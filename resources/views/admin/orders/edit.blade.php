    ...
    <!-- Default box -->
                        ...
                        <td>
                            <form action="{{ route('admin.orders.update', $order->id) }}" method="post">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn"><button onclick="return confirm('Bạn chắc chắn thực hiện thành động này?')" type="submit" class="btn btn-primary">Cập nhật</button></span>
                                </div>
                            </form>
                        </td>
                    </tr>
        ...
        @if($order)
            ...
            <div class="box-footer">
                <div class="btn-group">
                    <a href="{{ route('admin.orders.show', $order->id) }}" class="btn btn-default">Quay lại danh sách</a>
                </div>
            </div>
        @endif
