            ...
            <form action="{{ route('admin.employees.update', $employee->id) }}" method="post" class="form">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" placeholder="Tên nhân viên" class="form-control" value="{!! $employee->name ?: old('name')  !!}">
                    </div>
                    <div class="form-group">
                ...
                <div class="box-footer">
                    <div class="btn-group">
                        <a href="{{ route('admin.employees.index') }}" class="btn btn-default btn-sm">Quay lại danh sách</a>
