...
class ProductController extends Controller
{
    ...
    {
//        dd('đá');
        $result = $this->productRepo->createProductAPI($request);
...
//            'sssss' => $this->categoryRepo->paginateArrayResults($list->all())
//        ]);
    }
    ...
    public function removeImage(Request $request)
    {
        ...
        return redirect()->back()->with('message', 'Image Xóa thành công');
    }
